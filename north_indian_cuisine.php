...
// Retrieve dishes with cuisine "North Indian Cuisine"
$sql = "SELECT * FROM recipes WHERE cuisine = 'North Indian Cuisine'";
...
<head>
    ...
    <title>North Indian Cuisine - Dish' Covery</title>
    <!-- Bootstrap CSS -->
...
<body>
<div class="container">
    <h2 class="my-4 text-center" style="color: #f8c000;">North Indian Cuisine</h2>
