...
// Retrieve dishes with cuisine "South Indian Cuisine"
$sql = "SELECT * FROM recipes WHERE cuisine = 'South Indian Cuisine'";
...
<head>
    ...
    <title>South Indian Cuisine - Dish' Covery</title>
    <!-- Bootstrap CSS -->
...
<body>
<div class="container">
    <h2 class="my-4 text-center" style="color: #f8c000;">South Indian Cuisine</h2>
