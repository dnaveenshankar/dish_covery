...
// Retrieve dishes with cuisine "Sweets"
$sql = "SELECT * FROM recipes WHERE cuisine = 'Sweet'";
...
<head>
    ...
    <title>Sweets - Dish' Covery</title>
    <!-- Bootstrap CSS -->
...
<body>
<div class="container">
    <h2 class="my-4 text-center" style="color: #f8c000;">Sweets</h2>
