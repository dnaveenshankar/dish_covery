...
// Retrieve dishes with cuisine "Kerala Cuisine"
$sql = "SELECT * FROM recipes WHERE cuisine = 'Kerala Cuisine'";
...
<head>
    ...
    <title>Kerala Cuisine - Dish' Covery</title>
    <!-- Bootstrap CSS -->
...
<body>
<div class="container">
    <h2 class="my-4 text-center" style="color: #f8c000;">Kerala Cuisine</h2>
