...
// Define the cuisine to be displayed (change this accordingly)
$cuisine = "Other Cuisines";

// Retrieve dishes with the specified cuisine
...
<head>
    ...
    <title><?php echo $cuisine; ?> - Dish' Covery</title>
    <!-- Bootstrap CSS -->
...
<body>
<div class="container">
    <h2 class="my-4 text-center" style="color: #f8c000;"><?php echo $cuisine; ?></h2>
