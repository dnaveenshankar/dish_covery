...
// Retrieve dishes with cuisine "Punjabi Cuisine"
$sql = "SELECT * FROM recipes WHERE cuisine = 'Punjabi Cuisine'";
...
<head>
    ...
    <title>Punjabi Cuisine - Dish' Covery</title>
    <!-- Bootstrap CSS -->
...
<body>
<div class="container">
    <h2 class="my-4 text-center" style="color: #f8c000;">Punjabi Cuisine</h2>
